...
void PcdInit()
{
    ...
    RCC_AHB1PeriphClockCmd(MF522_RST_CLK, ENABLE);
    ...
    /* Enable the GPIO Clock */
    RCC_AHB1PeriphClockCmd(MF522_MISO_CLK, ENABLE);
    ...
    /* Enable the GPIO Clock */
    RCC_AHB1PeriphClockCmd(MF522_MOSI_CLK, ENABLE);
    ...
    /* Enable the GPIO Clock */
    RCC_AHB1PeriphClockCmd(MF522_SCK_CLK, ENABLE);
    ...
    /* Enable the GPIO Clock */
    RCC_AHB1PeriphClockCmd(MF522_NSS_CLK, ENABLE);
