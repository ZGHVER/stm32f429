...
void SE_KeyMap_init(){
    ...
    USART3_NvicInit.NVIC_IRQChannel = USART3_IRQn;                       //�ж�Ƶ��
    USART3_NvicInit.NVIC_IRQChannelCmd = ENABLE;
    USART3_NvicInit.NVIC_IRQChannelPreemptionPriority = 1;     //��ռ���ȼ��������ȼ�
    USART3_NvicInit.NVIC_IRQChannelSubPriority = 1;            //�ύ���ȼ��������ȼ�
...
void USART3_IRQHandler(){
    ...
    if(USART_GetITStatus(USART3, USART_IT_RXNE) == SET){
				  resdat = USART_ReceiveData(USART3);
